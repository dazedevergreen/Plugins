...
void SurgicalSimulate::CreateQtPartControl(QWidget* parent)
{
  ...
  connect(m_Controls.pushButton_connectKuka, &QPushButton::clicked, this, &SurgicalSimulate::UseKuka);/*ssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  //connect(m_Controls.pushButton_connectKuka, &QPushButton::clicked, this, &SurgicalSimulate::UseVirtualDevice2);
  connect(m_Controls.pushButton_connectVega, &QPushButton::clicked, this, &SurgicalSimulate::UseVega);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  //connect(m_Controls.pushButton_connectVega, &QPushButton::clicked, this, &SurgicalSimulate::UseVirtualDevice1);
  connect(m_Controls.pushButton_captureRobot, &QPushButton::clicked, this, &SurgicalSimulate::OnRobotCapture);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_automove, &QPushButton::clicked, this, &SurgicalSimulate::OnAutoMove);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_selfcheck, &QPushButton::clicked, this, &SurgicalSimulate::OnSelfCheck);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_resetRobotReg, &QPushButton::clicked, this, &SurgicalSimulate::OnResetRobotRegistration);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_assembleNavigationObject, &QPushButton::clicked, this, &SurgicalSimulate::SetupNavigatedImage);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  ...
  connect(m_Controls.pushButton_startTracking, &QPushButton::clicked, this, &SurgicalSimulate::StartTracking);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  ...
  connect(m_Controls.pushButton_startAutoPosition, &QPushButton::clicked, this, &SurgicalSimulate::OnAutoPositionStart);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_gotoPlaneEdge, &QPushButton::clicked, this, &SurgicalSimulate::OnAutoPositionStart);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_saveRobotRegist, &QPushButton::clicked, this, &SurgicalSimulate::OnSaveRobotRegistraion);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_usePreRobotRegit, &QPushButton::clicked, this, &SurgicalSimulate::OnUsePreRobotRegitration);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  ...
  connect(m_Controls.pushButton_confirmImageTargetLine, &QPushButton::clicked, this, &SurgicalSimulate::InterpretImageLine);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  ...
  connect(m_Controls.pushButton_InitializeTcp, &QPushButton::clicked, this, &SurgicalSimulate::ResetRobotTcp);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_setTcpPrecisionTest, &QPushButton::clicked, this, &SurgicalSimulate::SetPrecisionTestTcp);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_setPlanePrecisionTestTcp, &QPushButton::clicked, this, &SurgicalSimulate::SetPlanePrecisionTestTcp);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_recordInitial, &QPushButton::clicked, this, &SurgicalSimulate::RecordInitial);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_goToInitial, &QPushButton::clicked, this, &SurgicalSimulate::GoToInitial);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/

  connect(m_Controls.pushButton_xm, &QPushButton::clicked, this, &SurgicalSimulate::TranslateX_minus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_xp, &QPushButton::clicked, this, &SurgicalSimulate::TranslateX_plus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_ym, &QPushButton::clicked, this, &SurgicalSimulate::TranslateY_minus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_yp, &QPushButton::clicked, this, &SurgicalSimulate::TranslateY_plus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_zm, &QPushButton::clicked, this, &SurgicalSimulate::TranslateZ_minus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_zp, &QPushButton::clicked, this, &SurgicalSimulate::TranslateZ_plus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/

  connect(m_Controls.pushButton_rxm, &QPushButton::clicked, this, &SurgicalSimulate::RotateX_minus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_rxp, &QPushButton::clicked, this, &SurgicalSimulate::RotateX_plus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_rym, &QPushButton::clicked, this, &SurgicalSimulate::RotateY_minus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_ryp, &QPushButton::clicked, this, &SurgicalSimulate::RotateY_plus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_rzm, &QPushButton::clicked, this, &SurgicalSimulate::RotateZ_minus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_rzp, &QPushButton::clicked, this, &SurgicalSimulate::RotateZ_plus);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_setFlangeTcp, &QPushButton::clicked, this, &SurgicalSimulate::ResetRobotTcp);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/

  connect(m_Controls.pushButton_confirmImageTargetPlane, &QPushButton::clicked, this, &SurgicalSimulate::InterpretImagePlane);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_goToFakePlane, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_goToFakePlane_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/

  connect(m_Controls.pushButton_updateRobotSimuPose, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_updateRobotSimuPose_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/

  connect(m_Controls.pushButton_a1_p, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a1_p_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a1_m, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a1_m_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a2_p, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a2_p_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a2_m, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a2_m_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a3_p, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a3_p_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a3_m, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a3_m_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a4_p, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a4_p_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a4_m, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a4_m_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a5_p, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a5_p_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a5_m, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a5_m_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a6_p, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a6_p_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a6_m, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a6_m_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a7_p, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a7_p_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_a7_m, &QPushButton::clicked, this, &SurgicalSimulate::On_pushButton_a7_m_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/

  connect(m_Controls.pushButton_endToolPower, &QPushButton::clicked, this, &SurgicalSimulate::StartTrackingWithPowerControl);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/

  connect(m_Controls.pushButton_robotCube, &QPushButton::clicked, this, &SurgicalSimulate::on_pushButton_robotCube_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_robotTwoPts, &QPushButton::clicked, this, &SurgicalSimulate::on_pushButton_robotTwoPts_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_thaMaxSpace, &QPushButton::clicked, this, &SurgicalSimulate::on_pushButton_thaMaxSpace_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_thaEffectiveSpace, &QPushButton::clicked, this, &SurgicalSimulate::on_pushButton_thaEffectiveSpace_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_tkaMaxSpace, &QPushButton::clicked, this, &SurgicalSimulate::on_pushButton_tkaMaxSpace_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_tkaEffectiveSpace, &QPushButton::clicked, this, &SurgicalSimulate::on_pushButton_tkaEffectiveSpace_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
  connect(m_Controls.pushButton_robotEmergencyBrake, &QPushButton::clicked, this, &SurgicalSimulate::on_pushButton_robotEmergencyBrake_clicked);/*sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss*/
