...
bool DaZuRobot::Reset(QTextBrowser* browser) {
	int nRet = HRIF_GrpReset(boxID, rbtID);
	UtilityFunction->PrintError(browser, nRet, "GrpReset");
	if (!nRet)
	{
		return true;
	}
...
bool DaZuRobot::SetFlangetoTCP(QTextBrowser* browser, std::array<double, 6> TCP) {
	...
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, TCP, "SetTCP");
	if (!nRet)
	{
		return true;
	}
...
bool DaZuRobot::ConfigFlangetoTCP(QTextBrowser* browser, std::array<double, 6> TCP, string TCP_Name) {
	...
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, TCP, "ConfigTCP");
...
bool DaZuRobot::ConfigBasetoUCS(QTextBrowser* browser, std::array<double, 6> UCS, string UCS_Name) {
	...
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, UCS, "UCS");
...
std::array<double, 6> DaZuRobot::ReadFlangetoTCP(QTextBrowser* browser) {
	...
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, FlangeToTCP, "FlangetoTCP");
...
std::array<double, 6> DaZuRobot::ReadBasetoTCP(QTextBrowser* browser) {
	...
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, BaseToTCP, "BaseToTCP");
...
std::array<double, 6> DaZuRobot::ReadBasetoTCP(QTextBrowser* browser, string sTcpName) {
	...
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, BaseToTCP, "BaseToTCP"+sTcpName);
...
std::array<double, 6> DaZuRobot::ReadBasetoFlange(QTextBrowser* browser) {
	...
	UtilityFunction->PrintXYZRXRYRZ(browser, 0, BasetoFlange, "BasetoFlange");
...
std::array<double, 6> DaZuRobot::ReadTargetBasetoTCP(QTextBrowser* browser) {
	...
	UtilityFunction->PrintError(browser, nRet, "ReadBaseToTCP :");
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, TargetBaseToTCP, "TargetBaseToTCP");
...
std::array<double, 6> DaZuRobot::ReadJoint(QTextBrowser* browser) {
	...
	UtilityFunction->PrintError(browser, nRet, "ReadBaseToTCP :");
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, Joint, "Joint");
...
std::array<double, 6> DaZuRobot::ReadTargetJoint(QTextBrowser* browser) {
	...
	UtilityFunction->PrintError(browser, nRet, "ReadTargetJoint :");
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, Joint, "ReadTargetJoint");
...
std::array<double, 6> DaZuRobot::ReadUCS(QTextBrowser* browser) {
	...
	UtilityFunction->PrintError(browser, nRet, "ReadBaseToUCS :");
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, UCS, "ReadBaseToUCS");
...
std::array<double, 6> DaZuRobot::ReadUCS(QTextBrowser* browser, string UCSName) {
	...
	UtilityFunction->PrintError(browser, nRet, "ReadBaseToUCS :"+ UCSName);
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, UCS, "BaseToUCS"+UCSName);
...
std::array<double, 6> DaZuRobot::GetInverseKin(QTextBrowser* browser, std::array<double, 6> TargetPoint) {
	...
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, TargetJoint, "TargetJoint");
...
bool DaZuRobot::SetForceZero(QTextBrowser* browser) {
	int nRet = HRIF_SetForceZero(boxID, rbtID);
	UtilityFunction->PrintError(browser, nRet, "SetForceZero");
	if (!nRet)
	{
		return true;
	}
...
std::array<double, 6> DaZuRobot::ReadFTCabData(QTextBrowser* browser) {
	std::array<double, 6> Force;
	int nRet = HRIF_ReadFTCabData(boxID, rbtID, Force[0], Force[1], Force[2], Force[3], Force[4], Force[5]);
	UtilityFunction->PrintError(browser, nRet, "ReadFTCabData");
	UtilityFunction->PrintXYZRXRYRZ(browser, nRet, Force, "Force");
	////////////////////////////////////////???????????????????????
	return Force;
}
