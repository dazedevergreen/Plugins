...
void DentalRobot::on_pushButton_implantToCrown_clicked()
{
...
void DentalRobot::on_pushButton_abutmentToImplant_clicked()
{
	// Check the availability of all the data
...
void DentalRobot::on_pushButton_followAbutment_clicked()
{
	// Check the availability of all the data
	if (GetDataStorage()->GetNamedNode("abutment_tip_pts") == nullptr)
	{
...
void DentalRobot::on_pushButton_followCrown_clicked()
{
	// Check the availability of all the data
	if (GetDataStorage()->GetNamedNode("crown_tip_pts") == nullptr)
	{
...
//void DentalRobot::on_pushButton_testMoveImplant_clicked()
//{
//	if (GetDataStorage()->GetNamedNode("implant_to_move") == nullptr)
//	{
//		m_Controls.textBrowser->append("implant_to_move is missing");
...
void DentalRobot::ProjectImplantOntoPanorama()
{
