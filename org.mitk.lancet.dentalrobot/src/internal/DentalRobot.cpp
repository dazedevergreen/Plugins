...
const std::string DentalRobot::VIEW_ID = "org.mitk.views.dentalrobot";

void DentalRobot::SetFocus()
{
  m_Controls.pushButton_planeAdjust->setFocus();
}

void DentalRobot::InitPointSetSelector(QmitkSingleNodeSelectionWidget* widget)
{
...
void DentalRobot::CreateQtPartControl(QWidget *parent)
{
	m_Controls.setupUi(parent);
	//Activate Robotic Arm and Camera
	InitPointSetSelector(m_Controls.mitkNodeSelectWidget_imageTargetLine);
	connect(m_Controls.pushButton_connectArm, &QPushButton::clicked, this, &DentalRobot::connectArm);
	connect(m_Controls.pushButton_powerOn, &QPushButton::clicked, this, &DentalRobot::powerOn);
	connect(m_Controls.pushButton_powerOff, &QPushButton::clicked, this, &DentalRobot::powerOff);
	connect(m_Controls.pushButton_connectCamrea, &QPushButton::clicked, this, &DentalRobot::connectCamera);
	connect(m_Controls.pushButton_updataData, &QPushButton::clicked, this, &DentalRobot::openCameraQtTimer);

	//Robot Registration
	connect(m_Controls.pushButton_setTCPToFlange, &QPushButton::clicked, this, &DentalRobot::setTCPToFlange);
	connect(m_Controls.pushButton_setInitialPoint, &QPushButton::clicked, this, &DentalRobot::setInitialPoint);
	connect(m_Controls.pushButton_goToInitial, &QPushButton::clicked, this, &DentalRobot::goToInitial);
	connect(m_Controls.pushButton_captureRobot, &QPushButton::clicked, this, &DentalRobot::captureRobot);
	connect(m_Controls.pushButton_replaceRegistration, &QPushButton::clicked, this, &DentalRobot::replaceRegistration);
	connect(m_Controls.pushButton_saveArmMatrix, &QPushButton::clicked, this, &DentalRobot::saveArmMatrix);
	connect(m_Controls.pushButton_reuseArmMatrix, &QPushButton::clicked, this, &DentalRobot::reuseArmMatrix);
	connect(m_Controls.pushButton_JiontAngleMotion, &QPushButton::clicked, this, &DentalRobot::JiontAngleMotion);
	connect(m_Controls.pushButton_AutoMoveJ, &QPushButton::clicked, this, &DentalRobot::AutoMoveJ);
	//Robot Move
	connect(m_Controls.pushButton_xp, &QPushButton::clicked, this, &DentalRobot::xp);
	connect(m_Controls.pushButton_xm, &QPushButton::clicked, this, &DentalRobot::xm);
	connect(m_Controls.pushButton_yp, &QPushButton::clicked, this, &DentalRobot::yp);
	connect(m_Controls.pushButton_ym, &QPushButton::clicked, this, &DentalRobot::ym);
	connect(m_Controls.pushButton_zp, &QPushButton::clicked, this, &DentalRobot::zp);
	connect(m_Controls.pushButton_zm, &QPushButton::clicked, this, &DentalRobot::zm);
	connect(m_Controls.pushButton_rxp, &QPushButton::clicked, this, &DentalRobot::rxp);
	connect(m_Controls.pushButton_rxm, &QPushButton::clicked, this, &DentalRobot::rxm);
	connect(m_Controls.pushButton_ryp, &QPushButton::clicked, this, &DentalRobot::ryp);
	connect(m_Controls.pushButton_rym, &QPushButton::clicked, this, &DentalRobot::rym);
	connect(m_Controls.pushButton_rzp, &QPushButton::clicked, this, &DentalRobot::rzp);
	connect(m_Controls.pushButton_rzm, &QPushButton::clicked, this, &DentalRobot::rzm);

	//Image Registration
	connect(m_Controls.pushButton_calibrateTCP, &QPushButton::clicked, this, &DentalRobot::calibrateTCP);
	connect(m_Controls.pushButton_saveTCPResult, &QPushButton::clicked, this, &DentalRobot::saveTCPCalibrateMatrix);
	connect(m_Controls.pushButton_reuseTCPResult, &QPushButton::clicked, this, &DentalRobot::reuseTCPCalibrateMatrix);
	connect(m_Controls.pushButton_collectDitch, &QPushButton::clicked, this, &DentalRobot::collectDitch);
	connect(m_Controls.pushButton_resetImageRegis, &QPushButton::clicked, this, &DentalRobot::resetImageRegistration);
	connect(m_Controls.pushButton_imageRegistration, &QPushButton::clicked, this, &DentalRobot::imageRegistration);
	connect(m_Controls.pushButton_saveImageregisResult, &QPushButton::clicked, this, &DentalRobot::saveImageregisResult);
	connect(m_Controls.pushButton_reuseImageregisResult, &QPushButton::clicked, this, &DentalRobot::reuseImageregisResult);
	connect(m_Controls.pushButton_startNavi, &QPushButton::clicked, this, &DentalRobot::startNavigation);

	//Navigation
	connect(m_Controls.pushButton_confirmImageTargetLine, &QPushButton::clicked, this, &DentalRobot::OnAutoPositionStart);



	// create GUI widgets from the Qt Designer's .ui file
	
	connect(m_Controls.pushButton_planeAdjust, &QPushButton::clicked, this, &DentalRobot::on_pushButton_planeAdjust_clicked);
	connect(m_Controls.pushButton_splineAndPanorama, &QPushButton::clicked, this, &DentalRobot::on_pushButton_splineAndPanorama_clicked);
	connect(m_Controls.pushButton_autoGenerate, &QPushButton::clicked, this, &DentalRobot::on_pushButton_AutoGenerate_clicked);
	connect(m_Controls.pushButton_viewPano, &QPushButton::clicked, this, &DentalRobot::on_pushButton_viewPano_clicked);
	connect(m_Controls.pushButton_viewCursiveMPR, &QPushButton::clicked, this, &DentalRobot::on_pushButton_viewCursiveMPR_clicked);

	m_Controls.horizontalSlider->setMinimum(0);
	m_Controls.horizontalSlider->setMaximum(200);
	connect(m_Controls.horizontalSlider, &QSlider::valueChanged, this, &DentalRobot::valueChanged_horizontalSlider);

	connect(m_Controls.pushButton_CBCTreconstruct, &QPushButton::clicked, this, &DentalRobot::on_pushButton_CBCTreconstruct_clicked);
	connect(m_Controls.pushButton_iosCBCT, &QPushButton::clicked, this, &DentalRobot::on_pushButton_iosCBCT_clicked);
	connect(m_Controls.pushButton_setCrown, &QPushButton::clicked, this, &DentalRobot::on_pushButton_setCrown_clicked);
	connect(m_Controls.pushButton_setImplant, &QPushButton::clicked, this, &DentalRobot::on_pushButton_setImplant_clicked);
	connect(m_Controls.pushButton_steelballExtract, &QPushButton::clicked, this, &DentalRobot::on_pushButton_steelballExtract_clicked);
	/*connect(m_Controls.pushButton_connectVega, &QPushButton::clicked, this, &DentalRobot::on_pushButton_connectVega_clicked);
	connect(m_Controls.pushButton_updateData, &QPushButton::clicked, this, &DentalRobot::on_pushButton_updateData_clicked);
	connect(m_Controls.pushButton_imageRegis, &QPushButton::clicked, this, &DentalRobot::on_pushButton_imageRegis_clicked);
	connect(m_Controls.pushButton_calibrateDrill, &QPushButton::clicked, this, &DentalRobot::on_pushButton_calibrateDrill_clicked);
	connect(m_Controls.pushButton_saveresult, &QPushButton::clicked, this, &DentalRobot::on_pushButton_saveCalibrateMatrix_clicked);
	connect(m_Controls.pushButton_reuseresult, &QPushButton::clicked, this, &DentalRobot::on_pushButton_reuseImageMatrix_clicked);*/
	/*connect(m_Controls.pushButton_genSplineAndAppend, &QPushButton::clicked, this, &DentalRobot::on_pushButton_genSplineAndAppend_clicked);
	connect(m_Controls.pushButton_GenSeeds, &QPushButton::clicked, this, &DentalRobot::on_pushButton_GenSeeds_clicked);*/
	/*connect(m_Controls.pushButton_collectDitch, &QPushButton::clicked, this, &DentalRobot::on_pushButton_collectDitch_clicked);
	connect(m_Controls.pushButton_imageRegisNew, &QPushButton::clicked, this, &DentalRobot::on_pushButton_imageRegisNew_clicked);*/
	//connect(m_Controls.pushButton_resetImageRegis, &QPushButton::clicked, this, &DentalRobot::on_pushButton_resetImageRegis_clicked);
	connect(m_Controls.pushButton_implantFocus, &QPushButton::clicked, this, &DentalRobot::on_pushButton_implantFocus_clicked);

	connect(m_Controls.pushButton_U_ax, &QPushButton::clicked, this, &DentalRobot::on_pushButton_U_ax_clicked);
	connect(m_Controls.pushButton_D_ax, &QPushButton::clicked, this, &DentalRobot::on_pushButton_D_ax_clicked);
	connect(m_Controls.pushButton_R_ax, &QPushButton::clicked, this, &DentalRobot::on_pushButton_R_ax_clicked);
	connect(m_Controls.pushButton_L_ax, &QPushButton::clicked, this, &DentalRobot::on_pushButton_L_ax_clicked);
	connect(m_Controls.pushButton_D_cor, &QPushButton::clicked, this, &DentalRobot::on_pushButton_D_cor_clicked);
	connect(m_Controls.pushButton_D_sag, &QPushButton::clicked, this, &DentalRobot::on_pushButton_D_sag_clicked);
	connect(m_Controls.pushButton_U_cor, &QPushButton::clicked, this, &DentalRobot::on_pushButton_U_cor_clicked);
	connect(m_Controls.pushButton_U_sag, &QPushButton::clicked, this, &DentalRobot::on_pushButton_U_sag_clicked);
	connect(m_Controls.pushButton_L_cor, &QPushButton::clicked, this, &DentalRobot::on_pushButton_L_cor_clicked);
	connect(m_Controls.pushButton_R_cor, &QPushButton::clicked, this, &DentalRobot::on_pushButton_R_cor_clicked);
	connect(m_Controls.pushButton_L_sag, &QPushButton::clicked, this, &DentalRobot::on_pushButton_L_sag_clicked);
	connect(m_Controls.pushButton_R_sag, &QPushButton::clicked, this, &DentalRobot::on_pushButton_R_sag_clicked);
	connect(m_Controls.pushButton_clock_cor, &QPushButton::clicked, this, &DentalRobot::on_pushButton_clock_cor_clicked);
	connect(m_Controls.pushButton_counter_cor, &QPushButton::clicked, this, &DentalRobot::on_pushButton_counter_cor_clicked);
	connect(m_Controls.pushButton_clock_sag, &QPushButton::clicked, this, &DentalRobot::on_pushButton_clock_sag_clicked);
	connect(m_Controls.pushButton_counter_sag, &QPushButton::clicked, this, &DentalRobot::on_pushButton_counter_sag_clicked);
	connect(m_Controls.pushButton_clock_ax, &QPushButton::clicked, this, &DentalRobot::on_pushButton_clock_ax_clicked);
	connect(m_Controls.pushButton_counter_ax, &QPushButton::clicked, this, &DentalRobot::on_pushButton_counter_ax_clicked);
	/*connect(m_Controls.pushButton_startNavi, &QPushButton::clicked, this, &DentalRobot::on_pushButton_startNavi_clicked);
	connect(m_Controls.pushButton_startNaviImplant, &QPushButton::clicked, this, &DentalRobot::on_pushButton_startNaviImplant_clicked);*/
	//connect(m_Controls.pushButton_testMoveImplant, &QPushButton::clicked, this, &DentalRobot::on_pushButton_testMoveImplant_clicked);
	//connect(m_Controls.pushButton_followAbutment, &QPushButton::clicked, this, &DentalRobot::on_pushButton_followAbutment_clicked);
	//connect(m_Controls.pushButton_followCrown, &QPushButton::clicked, this, &DentalRobot::on_pushButton_followCrown_clicked);
	//connect(m_Controls.pushButton_implantTipExtract, &QPushButton::clicked, this, &DentalRobot::on_pushButton_implantTipExtract_clicked);
	//// connect(m_Controls.comboBox_plate, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &DentalRobot::on_comboBox_plate_changed);
	//connect(m_Controls.pushButton_implantToCrown, &QPushButton::clicked, this, &DentalRobot::on_pushButton_implantToCrown_clicked);
	//connect(m_Controls.pushButton_abutmentToImplant, &QPushButton::clicked, this, &DentalRobot::on_pushButton_abutmentToImplant_clicked);



}

void DentalRobot::on_pushButton_implantTipExtract_clicked()
{
...
bool DentalRobot::ObtainImplantExitEntryPts(mitk::Surface::Pointer implantSurface, mitk::PointSet::Pointer exitEntryPts)
{
...
bool DentalRobot::CutPolyDataWithPlane(vtkSmartPointer<vtkPolyData> dataToCut, vtkSmartPointer<vtkPolyData> largerSubPart, vtkSmartPointer<vtkPolyData> smallerSubPart, double planeOrigin[3], double planeNormal[3])
{
...
void DentalRobot::on_pushButton_GenSeeds_clicked()
{
...
void DentalRobot::on_pushButton_genSplineAndAppend_clicked()
{
...
void DentalRobot::ShowToolStatus_Vega()
{
...
void DentalRobot::on_pushButton_steelballExtract_clicked()
{
...
void DentalRobot::on_pushButton_setImplant_clicked()
{
...
double DentalRobot::CalImplantToAlveolarNerve()
{
...
void DentalRobot::on_pushButton_setCrown_clicked()
{
	auto crownNode = GetDataStorage()->GetNamedNode("crown");
...
void DentalRobot::on_pushButton_iosCBCT_clicked()
{
...
void DentalRobot::on_pushButton_CBCTreconstruct_clicked()
{
...
void DentalRobot::on_pushButton_U_ax_clicked()
{
	if(GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_D_ax_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_R_ax_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_L_ax_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_U_sag_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_U_cor_clicked()
{
	on_pushButton_U_sag_clicked();
}
void DentalRobot::on_pushButton_D_sag_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_D_cor_clicked()
{
	on_pushButton_D_sag_clicked();
}
void DentalRobot::on_pushButton_L_cor_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_R_cor_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_R_sag_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_L_sag_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_clock_cor_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_counter_cor_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_clock_sag_clicked()
{
...
void DentalRobot::on_pushButton_counter_sag_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_clock_ax_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_counter_ax_clicked()
{
	if (GetDataStorage()->GetNamedNode("implant") == nullptr)
	{
		m_Controls.textBrowser->append("implant is missing");
...
void DentalRobot::on_pushButton_implantFocus_clicked()
{
...
void DentalRobot::valueChanged_horizontalSlider()
{
...
void DentalRobot::on_pushButton_viewPano_clicked()
{
...
void DentalRobot::on_pushButton_planeAdjust_clicked()
{
	auto attemptNode = GetDataStorage()->GetNamedNode("CBCT Bounding Shape_cropped");
...
void DentalRobot::on_pushButton_splineAndPanorama_clicked()
{
	//生成样条曲线
	...
	//创建vtk对象polydata，将所有points、lines加入进去，vtkpolydata是用来存储几何数据（点、线、面）的数据结构
	// vtkPolyData
	auto polyData = vtkSmartPointer<vtkPolyData>::New();
	polyData->SetPoints(points);
	polyData->SetLines(lines);
	//创建spline对象，用于生成样条曲线
	auto spline = vtkCardinalSpline::New();
	spline->SetLeftConstraint(2);//左侧约束类型（2表示2阶导数）
	spline->SetLeftValue(0.0);//指定值为0.0
	spline->SetRightConstraint(2);
	spline->SetRightValue(0.0);

	//设置样条曲线分段长度
	double segLength{ 0.3 };
	//创建了一个vtk对象splineFilter，对vtkPolyData应用样条曲线滤波器
	vtkNew<vtkSplineFilter> splineFilter;
	splineFilter->SetInputData(polyData);
	splineFilter->SetLength(segLength);
	splineFilter->SetSubdivideToLength();//配准滤波器按照长度细分样条
	splineFilter->SetSpline(spline);//将配置好的vtkCardinalSpline对象传递给滤波器
	splineFilter->Update();//运行滤波器来生成样条曲线

	auto spline_PolyData = splineFilter->GetOutput();//获取生成的样条曲线数据

	// Add the spline polydata into datastorage
	//若存在"Dental curve"的节点，则删除该对象
	if(GetDataStorage()->GetNamedNode("Dental curve") != nullptr)
	{
	...
	//将所有spline_PolyData的点都添加到mitkPsetNew之中
	...
	//创建和添加新节点DataNode
	auto curveNode = mitk::DataNode::New();
	curveNode->SetData(mitkPsetNew);//将mitkPsetNew设置为这个节点的数据
	curveNode->SetName("Dental curve");//命名为Dental curve
	curveNode->SetFloatProperty("point 2D size", 0.3);//设置节点的浮点数据类型，此处设置point 2D size为0.3
	GetDataStorage()->Add(curveNode);//将新创建的节点添加到MITK存储当中

	//生成全景图像
	vtkSmartPointer<vtkImageAppend> append = vtkSmartPointer<vtkImageAppend>::New();

	append->SetAppendAxis(2);//append对象设置在第三维Z轴上添加图像数据

	int thickness{ 30 };

	auto attemptImageNode = GetDataStorage()->GetNamedNode("CBCT Bounding Shape_cropped");//获取名为CBCT Bounding Shape_cropped的节点
	...
	for (int i{ 0 }; i < 2 * thickness; i++)
	{
		...
		auto expandedSpline = ExpandSpline(spline_PolyData, spline_PolyData->GetNumberOfPoints() - 1, stepSize);//调用函数生成扩展的样条曲线
		...
		auto surface =
			SweepLine_2Sides(expandedSpline, direction, distance, cols);//调用函数生成表面：扩展后的曲线、方向、距离和列数
		//添加探测表面到数据存储中
		if(i == thickness)
		{
...
void DentalRobot::on_pushButton_AutoGenerate_clicked()
{
	...
	if (attemptImageNode == nullptr)
	{
		m_Controls.textBrowser->append("CBCT Bounding Shape_cropped Image is missing");
		return;
	}
	...
	gaussianSmooth->SetInputData(vtkImage);
	gaussianSmooth->SetStandardDeviations(1.0, 1.0, 0.0); // 根据需要调整
	gaussianSmooth->Update();

	// 边缘检测：提取牙弓边缘
	vtkNew<vtkImageGradientMagnitude> gradientMagnitude;
	gradientMagnitude->SetInputConnection(gaussianSmooth->GetOutputPort());
	gradientMagnitude->Update();

	vtkNew<vtkImageThreshold> threshold;
	threshold->SetInputConnection(gradientMagnitude->GetOutputPort());
	threshold->ThresholdByLower(50); // 50为示例阈值，根据实际情况调整
	...
	contourFilter->SetValue(0, 1); // 提取值为1的轮廓
	contourFilter->Update();

	// 创建vtk点集对象points，将轮廓点复制进去
	vtkNew<vtkPoints> points;
	vtkNew<vtkCellArray> lines;
	auto contourPolyData = contourFilter->GetOutput();

	for (vtkIdType i = 0; i < contourPolyData->GetNumberOfPoints(); ++i)
	{
		double pt[3];
		contourPolyData->GetPoint(i, pt);
		points->InsertNextPoint(pt);
	}

	lines->InsertNextCell(contourPolyData->GetNumberOfPoints());
	for (vtkIdType i = 0; i < contourPolyData->GetNumberOfPoints(); ++i)
	{
		lines->InsertCellPoint(i);
	}

	// 创建vtkPolyData对象，将点和线加入进去
	auto polyData = vtkSmartPointer<vtkPolyData>::New();
	polyData->SetPoints(points);
	polyData->SetLines(lines);
	...
	m_Controls.textBrowser->append("Dental curve generated successfully.");
}


void DentalRobot::on_pushButton_viewCursiveMPR_clicked()
{
	auto attemptNode = GetDataStorage()->GetNamedNode("CBCT Bounding Shape_cropped");
...
void DentalRobot::TurnOffAllNodesVisibility()
{
...
vtkSmartPointer<vtkPolyData> DentalRobot::ExpandSpline(vtkPolyData* line, int divisionNum,
	double stepSize)
{
...
vtkSmartPointer<vtkPolyData> DentalRobot::SweepLine_2Sides(vtkPolyData* line, double direction[3],
...
void DentalRobot::UpdateAllBallFingerPrint(mitk::PointSet::Pointer stdSteelballCenters)
{
...
double DentalRobot::GetPointDistance(const mitk::Point3D p0, const mitk::Point3D p1)
{
...
bool DentalRobot::GetCoarseSteelballCenters(double steelballVoxel)
{
...
void DentalRobot::ScreenCoarseSteelballCenters(int requiredNeighborNum, int stdNeighborNum, std::vector<int>& foundIDs)
{
...
void DentalRobot::IterativeScreenCoarseSteelballCenters(int requiredNeighborNum, int stdNeighborNum, std::vector<int>& foundIDs)
{
...
void DentalRobot::RemoveRedundantCenters()
{
	auto inputPointSet = dynamic_cast<mitk::PointSet*>(GetDataStorage()->GetNamedNode("Steelball centers")->GetData());
...
void DentalRobot::RearrangeSteelballs(int stdNeighborNum, std::vector<int>& foundIDs)
{
...
void DentalRobot::on_comboBox_plate_changed(int index)
{
	auto steelBalls_cmm = mitk::PointSet::New();
